 ...
 *
 * The compile dir is emptied on every compile, and it comes straight from the
 * APP_COMPILE_DIR environment variable. A one-character mistake there, such as
 * APP_COMPILE_DIR=/app instead of /app/var/di/prod, would otherwise wipe the whole
 * application. This guard rejects the two shapes that can only ever be a mistake:
 * the filesystem root, and a directory that holds the app dir.
 *
